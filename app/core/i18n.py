...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "feedback_download_prefill_subject": "Help with downloading {product}",
        "feedback_download_prefill_message_intro": "I need help with purchasing or downloading {product}.",
        "feedback_download_prefill_version": "Product version: {version}",
        "feedback_download_prefill_purchase_date": "Purchase date: {purchase_date}",
        "feedback_download_prefill_reference": "Support reference: {support_reference}",
        "feedback_download_prefill_details_prompt": "What happened:",
        ...
        "feedback_rate_limited": "Too many requests. Please wait before trying again.",
        "feedback_rate_limited_retry": "Too many requests. Please try again in {seconds} seconds.",
        ...
        "reviews_page_title": "User reviews — SmartBudget",
        "reviews_title": "User reviews",
        "reviews_subtitle": "Read feedback approved for public display.",
        "reviews_empty_title": "No published reviews yet",
        "reviews_empty": (
            "Published user reviews are not available for this product yet."
        ),
        "reviews_back_to_product": "Back to SmartBudget",
        ...
        "rate_limit_retry_after": "Please try again in {seconds} seconds.",
    },
    "ru": {
        ...
        "feedback_download_prefill_subject": "Помощь со скачиванием {product}",
        "feedback_download_prefill_message_intro": "Мне нужна помощь с покупкой или скачиванием {product}.",
        "feedback_download_prefill_version": "Версия продукта: {version}",
        "feedback_download_prefill_purchase_date": "Дата покупки: {purchase_date}",
        "feedback_download_prefill_reference": "Номер обращения: {support_reference}",
        "feedback_download_prefill_details_prompt": "Что произошло:",
        ...
        "feedback_rate_limited": "Слишком много запросов. Подождите перед повторной попыткой.",
        "feedback_rate_limited_retry": "Слишком много запросов. Повторите попытку через {seconds} сек.",
        ...
        "reviews_page_title": "Отзывы пользователей — SmartBudget",
        "reviews_title": "Отзывы пользователей",
        "reviews_subtitle": "Здесь собраны отзывы, одобренные для публикации.",
        "reviews_empty_title": "Опубликованных отзывов пока нет",
        "reviews_empty": (
            "Для этого продукта пока нет опубликованных отзывов пользователей."
        ),
        "reviews_back_to_product": "Вернуться к SmartBudget",
        ...
        "rate_limit_retry_after": "Повторите попытку через {seconds} сек.",
    },
}
